...
if __name__ == '__main__':
    ...
    # print('下单')
    # print(HuobiServices.orders(1, 'api', 'ethcny', 'buy-limit', 12))
    # print('执行订单')
    # print(HuobiServices.place_order('58840'))
    # print('撤销订单')
    # print(HuobiServices.cancel_order('58840'))
    # print('查询某个订单')
    # print(HuobiServices.order_info('58840'))
    # print('查询某个订单的成交明细')
    # print(HuobiServices.order_matchresults('45421'))
    # print('查询当前委托、历史委托')
